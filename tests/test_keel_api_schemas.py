...
class TestApiSchemas(unittest.TestCase):
    ...
    def test_openapi_includes_typed_paths(self):
        ...
        self.assertIn("shadow_near_probe", status_props)
        self.assertIn("shadow_near_probe_cooldown_seconds", status_props)
        self.assertIn("shadow_near_probe_edge_mode", status_props)
        self.assertIn("shadow_near_probe_hurdle_bps", status_props)
        ...
        self.assertIn("shadow_near_probe", config_props)
        self.assertIn("shadow_near_probe_cooldown_seconds", config_props)
        self.assertIn("shadow_near_probe_max_missing", config_props)
        self.assertIn("shadow_near_probe_edge_mode", config_props)
        self.assertIn("shadow_near_probe_hurdle_bps", config_props)
        self.assertIn("max_notional_per_instrument", config_props)
        self.assertIn("max_contracts_per_instrument", config_props)
        self.assertIn("live_max_notional_per_instrument", config_props)
        self.assertIn("live_max_contracts_per_instrument", config_props)
        self.assertIn("effective_max_notional_per_instrument", config_props)
        self.assertIn("effective_max_contracts_per_instrument", config_props)
    ...
    def test_kill_switch_on_status_and_config(self):
        ...
        self.assertFalse(status.shadow_near_probe)
        self.assertEqual(status.shadow_near_probe_cooldown_seconds, 900)
        ...
        self.assertFalse(cfg.shadow_near_probe)
        self.assertEqual(cfg.shadow_near_probe_cooldown_seconds, 900)
        self.assertEqual(cfg.shadow_near_probe_max_missing, 2)
