...
| Date | Note |
|------|------|
| 2026-09-08 | **F2b TF RSI pullback**: `KEEL_RULE_TF_PULLBACK` default 1; long `rsi<=52` / short `rsi>=48` (`KEEL_RULE_TF_RSI_PULLBACK_*`); gate `pullback_ok`; MR ignores; E0 freeze unchanged |
